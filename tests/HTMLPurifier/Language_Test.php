...
class HTMLPurifier_LanguageTest extends HTMLPurifier_Harness
{
    ...
    protected function generateEnLanguage()
    {
        ...
        $config = HTMLPurifier_Config::create(['Core.Language' => 'en']);
    ...
    public function test_formatMessage()
    {
        ...
        $this->assertIdentical($lang->formatMessage('LanguageTest: Error', [1 => 'fatal', 32]), 'Error is fatal on line 32');
    }
    ...
    public function test_formatMessage_tokenParameter()
    {
        ...
        $this->assertIdentical(
            $lang->formatMessage(
                ...
                [1 => new HTMLPurifier_Token_Start('a', ['href' => 'http://example.com'], 18)]
            ),
        ...
        $this->assertIdentical(
            $lang->formatMessage(
                ...
                [1 => new HTMLPurifier_Token_Text('data>', 23)]
            ),
    ...
    public function test_listify()
    {
        ...
        $this->assertEqual($lang->listify(['Item']), 'Item');
        $this->assertEqual($lang->listify(['Item', 'Item2']), 'Item and Item2');
        $this->assertEqual($lang->listify(['Item', 'Item2', 'Item3']), 'Item, Item2 and Item3');
    }
