 ...
 */
class Html_Purifier_attr_Validator
{
    /**
     ...
     */
    public function validate_token($token, $config, $context)
    {
        ...
        if (!$ok) {
            $id_accumulator = Html_Purifier_id_Accumulator::build($config, $context);
        ...
        if (!$token instanceof Html_Purifier_token_start && !$token instanceof Html_Purifier_token_empty) {
            return;
        }
